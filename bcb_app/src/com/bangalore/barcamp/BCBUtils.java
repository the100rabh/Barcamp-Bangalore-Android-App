...
public class BCBUtils {
	...
	private static final String BCB_USER_SCHEDULE_URL = "http://barcampbangalore.org/bcb/wp-android_helper.php?action=getuserdata&userid=%1&userkey=%2";
	...
	public static void addNavigationActions(
		...
		view = homeActivity.findViewById(R.id.nav_login);
		view.setOnClickListener(new OnClickListener() {
